...
class GameStateHelper
{
	...
	top(a) {
		return this.shift(a, this.shifts[0]);
	}
	bottom(a) {
		return this.shift(a, this.shifts[1]);
	}
	left(a) {
		return this.shift(a, this.shifts[2]);
	}
	right(a) {
		return this.shift(a, this.shifts[3]);
	}
    isEmpty(board, y, x) {
